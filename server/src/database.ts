...
export interface Book {
  ...
  status: 'available' | 'borrowed' | 'lost' | 'removed';
...
async function initDatabase() {
  ...
  if (db.data.users.length === 0) {
    ...
    db.data.users = [
      { id: 1, username: 'admin', email: 'admin@example.com', password: adminPassword, points: 999, role: 'admin', status: 'active', bio: '系统管理员', created_at: new Date().toISOString() },
      { id: 2, username: 'booklover', email: 'booklover@example.com', password: hashedPassword, points: 150, role: 'user', status: 'active', bio: '热爱阅读，喜欢分享好书', created_at: new Date().toISOString() },
      { id: 3, username: 'reader123', email: 'reader@example.com', password: hashedPassword, points: 80, role: 'user', status: 'active', bio: '书虫一枚，各种类型都读', created_at: new Date().toISOString() },
      { id: 4, username: 'bibliophile', email: 'biblio@example.com', password: hashedPassword, points: 200, role: 'user', status: 'active', bio: '藏书爱好者，愿意与大家分享', created_at: new Date().toISOString() }
    ];

    db.data.books = [
      { id: 1, title: '百年孤独', author: '加西亚·马尔克斯', cover: 'https://picsum.photos/seed/book1/200/300', description: '魔幻现实主义文学代表作，讲述布恩迪亚家族七代人的传奇故事', category: '文学', condition: '九成新', owner_id: 2, current_holder_id: 2, status: 'available', approval_status: 'approved', reviewed_by: 1, reviewed_at: new Date().toISOString(), points_required: 15, created_at: new Date().toISOString() },
      { id: 2, title: '三体', author: '刘慈欣', cover: 'https://picsum.photos/seed/book2/200/300', description: '中国科幻里程碑之作，展现宇宙级别的文明冲突', category: '科幻', condition: '全新', owner_id: 3, current_holder_id: 3, status: 'available', approval_status: 'approved', reviewed_by: 1, reviewed_at: new Date().toISOString(), points_required: 20, created_at: new Date().toISOString() },
      { id: 3, title: '小王子', author: '安托万·德·圣-埃克苏佩里', cover: 'https://picsum.photos/seed/book3/200/300', description: '写给大人的童话，关于爱与责任的寓言', category: '童话', condition: '八成新', owner_id: 2, current_holder_id: 2, status: 'available', approval_status: 'approved', reviewed_by: 1, reviewed_at: new Date().toISOString(), points_required: 8, created_at: new Date().toISOString() },
      { id: 4, title: '活着', author: '余华', cover: 'https://picsum.photos/seed/book4/200/300', description: '讲述一个人和他的命运之间的友情', category: '文学', condition: '九成新', owner_id: 4, current_holder_id: 4, status: 'available', approval_status: 'approved', reviewed_by: 1, reviewed_at: new Date().toISOString(), points_required: 12, created_at: new Date().toISOString() },
      { id: 5, title: '人类简史', author: '尤瓦尔·赫拉利', cover: 'https://picsum.photos/seed/book5/200/300', description: '从认知革命到科学革命，重新审视人类历史', category: '历史', condition: '全新', owner_id: 3, current_holder_id: 3, status: 'available', approval_status: 'approved', reviewed_by: 1, reviewed_at: new Date().toISOString(), points_required: 18, created_at: new Date().toISOString() }
    ];
